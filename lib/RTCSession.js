...
const debug = rnDebug('JsSIP:RTCSession');
const debugerror = rnDebug('JsSIP:ERROR:RTCSession');
...
module.exports = class RTCSession extends EventEmitter
{
  ...
  _receiveInviteResponse(response)
  {
    ...
    switch (true)
    {
      case /^100$/.test(response.status_code):
        ...
        this._provisional('remote', response);
        break;
  ...
  _provisional(originator, response)
  {
    debug('provisional response');

    debug('emit "provisional"');
