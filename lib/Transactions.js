...
const rnDebug = require('./Logger');
const debugnict = rnDebug('JsSIP:NonInviteClientTransaction');
const debugict = rnDebug('JsSIP:InviteClientTransaction');
const debugact = rnDebug('JsSIP:AckClientTransaction');
const debugnist = rnDebug('JsSIP:NonInviteServerTransaction');
const debugist = rnDebug('JsSIP:InviteServerTransaction');
